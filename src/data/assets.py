...
def get_assets():
    global cache_assets
    progressbar.print(0, msg='Downloading assets')
    if not cache_assets:
        cache_assets = request.request('assets')
    assets = cache_assets
    progressbar.erase()
    progressbar.print(100, msg='Downloading assets')
    return assets
